...
const CARDS: CardItem[] = [
  {
    ...
    title: '周易算卦',
    sub: '六爻占筮',
    desc: '三枚铜钱摇六次，得本卦变卦，综合解读事业、感情、财运、健康。',
    modifier: 'zhouyi',
  },
  {
    view: 'bazi',
    ...
    title: '生辰八字',
    sub: '四柱推命',
    desc: '天干地支排四柱，五行十神论命格，纳音性格大运全解析。',
  },
  {
    view: 'fortune',
    icon: '签',
    title: '抽签问事',
    sub: '观音灵签',
    desc: '心中默念所问之事，诚心摇签，得签诗、典故与仙机详解。',
  },
  {
    view: 'tarot',
    icon: '🃏',
    title: '塔罗占卜',
    sub: '大阿尔卡纳',
    desc: '22张命运之牌，元素星体关联，单牌指引或时间之流三牌阵。',
  },
  {
    view: 'fengshui',
    icon: '風',
  ...
  },
  {
    ...
    title: '星座运势',
    sub: '星座速查',
    desc: '十二星座性格详解，今日运势、本周运势，配对分析一览。',
  },
];
